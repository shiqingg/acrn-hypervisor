...
ASM-GN-02: Name reserved for use by the assembler shall not be used for any other purpose
=========================================================================================

Name defined by developers shall not be the same as assembler directive,
instruction prefix, instruction mnemonic, and register name.
...
If .end directive is used in an Assembly file, it shall be the last statement.
All the statements past .end directive will not be processed by the assembler.
...
the following assembler directives could be used:
...
ASM-NC-02: Name defined by developers shall use lower case letters
==================================================================

Name defined by developers shall use lower case letters with the following
...
ASM-NC-04: Name defined by developers shall be less than 31 characters
======================================================================
